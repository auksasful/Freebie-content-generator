...
class TipsBookSettings:
    ...
    system_prompt = ""
    cover_page_image1_prompt = "Photo realistic image without text. Far view of "
    cover_page_image2_prompt = "Photo realistic image without text. Close up view of "
    image_prompt_default = "Photo realistic image without text of "
    image_prompt_bottom_1 = "Entire image without text of "
    image_prompt_bottom_2 = " related things close view"