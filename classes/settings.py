...
class TipsBookSettings:
    ...
    system_prompt = ""
    cover_page_image1_prompt = "You are an artist that creates a photo realistic image. Far view of "
    cover_page_image2_prompt = "You are an artist that creates a photo realistic image. Close up view of "
    image_prompt_default = "You are an artist that creates a photo realistic image of "
    image_prompt_bottom_1 = "Entire image created by an artist of "
    image_prompt_bottom_2 = " related things close view"